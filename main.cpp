...
int minValueIn(char array[], const int n);
...
int maxValueIn(char array[], const int n);
int maxValueIn(int array[ROWS][COLS]);
double maxValueIn(double array[ROWS][COLS]);
int maxValueIn(char array[ROWS][COLS]);

void ShiftLeft(int array[], const int n, int shifts);
void ShiftLeft(double array[], const int n, int shifts);
void ShiftLeft(char array[], const int n, int shifts);
...
void ShiftRight(int array[], const int n, int shifts);
void ShiftRight(double array[], const int n, int shifts);
void ShiftRight(char array[], const int n, int shifts);
